...
add_action('rest_api_init', 'x_register_search');

function x_register_search(){
    register_rest_route('x/v1', 'search', array(
        'methods' => WP_REST_SERVER::READABLE,
        'callback' => 'x_search_results'
    ));
}

function x_search_results($data) { 

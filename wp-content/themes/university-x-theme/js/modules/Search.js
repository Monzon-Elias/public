...
class Search {
  ...
  keyPressDispatcher(e) {
    if (e.keyCode == 83 && !this.isOpen && !$("input, textarea").is(":focus"))
      this.openOverlay();
    if (e.keyCode == 27 && this.isOpen) this.closeOverlay();
  }
  ...
  getResults() {
    $.getJSON(
      x_data.root_url + "/wp-json/x/v1/search?term=" + this.searchField.val(),
      (results) => {
        console.log(results);
        this.resultsDiv.html(`
        <div class="row">
          ...
          <div class="one-third">
            ...
            ${
              ...
              results.programs.length
                ? '<ul class="link-list min-list">'
                : `<p>No programs match that search. <a href="${x_data.root_url}/programs">View all programs</a></p>`
            }
              ${results.programs
                .map(
                  (item) =>
          ...
          <div class="one-third">
            ...
            ${
              ...
              results.campuses.length
                ? '<ul class="link-list min-list">'
                : `<p>No campuses match that search <a href="${x_data.root_url}/programs">View all programs</a></p>`
            }
              ${results.campuses
                .map(
                  (item) =>
            ...
            ${
              ...
              results.events.length
                ? ""
                : `<p>No events match that search <a href="${x_data.root_url}/events">View all events</a></p>`
            }
              ${results.events
                .map(
                  (item) =>
